...
//document.getElementById('history').addEventListener('click',checkHistory)
...
async function checkHistory(){
   ...
   fetch("http://localhost:8080/empreimb/viewHistory/"+userInfo.userID)
...
try{
    ...
    fetch("http://localhost:8080/empreimb/newReimb",{
   method:"PUT",
